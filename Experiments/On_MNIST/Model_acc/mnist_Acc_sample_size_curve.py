...
unl_mib = [98.47, 97.94, 98.19, 98.01, 98.76, 98.21]

unl_muv = [98.84, 99.38, 99.11, 99.23, 99.24, 99.25]
...
plt.savefig('mnist_acc_sample_size_curve.pdf', format='pdf', dpi=200)
plt.show()