...
plt.bar(x - width / 2 - width / 8 + width / 8 , unl_br,   width=0.168, label='VBU', color='r', edgecolor='black', hatch='/')
plt.bar(x - width / 8 - width / 16, unl_vib, width=0.168, label='PriMU$_{w}$', color='cornflowerblue', edgecolor='black', hatch='*')
plt.bar(x + width / 8, unl_self_r, width=0.168, label='PriMU$_{w/o}$', color='g', edgecolor='black', hatch='x')
plt.bar(x + width / 2 - width / 8 + width / 16, unl_hess_r, width=0.168, label='HBFU', color='orange', edgecolor='black', hatch='\\')
...
plt.savefig('cifar10_rt_sample_size_bar.pdf', format='pdf', dpi=200)
plt.show()
